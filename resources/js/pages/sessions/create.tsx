...
import { index, store } from '@/actions/App/Http/Controllers/SessionController';
...
/** Tambahkan menit ke datetime-local string, kembalikan datetime-local string */
...
export default function Create({ attractions }: Props) {
    const { data, setData, post, processing, errors } = useForm({
        attraction_id: '' as unknown as number,
        start_time: '',
        end_time: '',
        max_capacity: '' as unknown as number,
    });
                    ...
                    <div className="overflow-hidden rounded-2xl border border-border bg-card shadow-md">
                        ...
                        <div className="relative overflow-hidden bg-primary px-8 py-7">
                            ...
                            <div className="relative">
                                ...
                                <p className="mt-1 text-sm text-white/70">
                                    Buat slot waktu baru untuk sebuah attraction.
                                </p>
                            </div>
                        </div>
                        ...
                        <form onSubmit={submit} className="space-y-6 p-8">
                            ...
                            <div className="space-y-2">
                                ...
                                <Select
                                    value={data.attraction_id ? String(data.attraction_id) : ''}
                                ...
                                {selectedDuration !== null && (
                                    <p className="flex items-center gap-1.5 text-xs text-primary">
                                        ...
                                        Waktu selesai akan dihitung otomatis.
                                    </p>
                                )}
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="space-y-2">
                                    <div className="flex items-center justify-between">
                                        ...
                                        {selectedDuration !== null && data.end_time && (
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-xs text-muted-foreground">
                                    Maksimal 1.000 tamu per session.
                                </p>
