...
import { index, update } from '@/actions/App/Http/Controllers/AttractionController';
...
export default function Edit({ attraction }: EditProps) {
                        ...
                        <div className="relative overflow-hidden bg-accent px-8 py-7">
                            ...
                            <div className="relative">
                                ...
                                <p className="mt-1 text-sm text-white/70">
                                    Perbarui detail attraction di bawah ini.
                                </p>
                            </div>
                        </div>
                        ...
                        <form onSubmit={submit} className="space-y-6 p-8">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    className={`h-10 w-full ${errors.name ? 'border-destructive focus:ring-destructive/30' : ''}`}
                                />
